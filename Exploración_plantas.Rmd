...
kable(Tabla, digits = 2, caption = "La tabla de ejemplo") %>%  kable_styling(bootstrap_options = c("striped", "hover", "condense"), full_width = FALSE) %>% scroll_box(width = "200px", height = "150px")
